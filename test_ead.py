...
def example_ead():
    return SimpleEad(
        ...
        items=[
            EadItem.make(id="Dir1/Dir1-1/item1", identity=Identity(title="Item1")),
            EadItem.make(id="Dir1/item2", identity=Identity(title="Item2")),
            EadItem.make(id="Dir2/Dir2-1/item3", identity=Identity(title="Item3")),
            EadItem.make(id="Dir2/item4", identity=Identity(title="Item4")),
        ]
    )
