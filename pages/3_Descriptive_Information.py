...
st.session_state[KEYS.BIOG_HIST] = st.text_area("Biographical information",
                                                help="Provide a succinct biographical overview of the person or "
                                                     "persons who created this collection."
                                                     "This is equivalent to ISAD(G) 3.2.2: "
...
st.session_state[KEYS.LANGS] = st.multiselect("Languages Used",
                                              ...
                                              help="Language or languages used in the collection's items. "
                                                   "This is equivalent to ISAD(G) 3.4.3: Languages of Material")
