...
init_page("Additional Info")

items = load_files(st.session_state.get(PREFIX))

st.write("## Additional information")

st.write("Information about this description")

st.session_state[KEYS.NOTES] = st.text_area("Description Notes",
                                            help="Enter any notes about the description of these materials. "
                                                 "This is equivalent to ISAD(G) 3.7.1: Archivist Note",
...
st.session_state[KEYS.DATE_DESC] = st.date_input("Date of description",
                                                 help="Enter the date this description was made. "
                                                      "This is equivalent to ISAD(G) 3.7.3: Dates of Description",
